...
public class ControllerProduct extends ControllerBase<Product> {
    public ControllerProduct() {
        super("table_products");
    }
    ...
    @Override
    public Product getSync(String referenceId) {
        try {
    ...
    @Override
    public ArrayList<Product> getAllSync() {
        try {
